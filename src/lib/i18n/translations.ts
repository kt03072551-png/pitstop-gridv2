...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    adminOrders: {
      ...
      mismatchWarning: "⚠️ Mismatch warning: The transfer amount on the slip is ฿500 less than the required invoice amount. Double-check before approval.",
  ...
  th: {
    ...
    adminOrders: {
      ...
      mismatchWarning: "⚠️ คำเตือนยอดไม่ตรง: ยอดโอนในสลิปน้อยกว่ายอดเรียกเก็บจริง ฿500 กรุณาตรวจสอบให้แน่ชัดก่อนกดอนุมัติ",
